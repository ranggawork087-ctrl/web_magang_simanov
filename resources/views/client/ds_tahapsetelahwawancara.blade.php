...
<main class="flex-1 flex justify-center">
    ...
    <div class="bg-white p-12 rounded-2xl shadow-sm border border-[#E5E7EB]
                w-[780px] min-h-[360px] my-auto flex flex-col items-center justify-center text-center"
        style="font-family: 'Manrope', sans-serif;">

        <!-- ICON (ganti gambarmu) -->
        <div class="w-20 h-20 mb-6">
            <img src="your-image.png" class="w-full h-full object-contain" />
        </div>

        <!-- TEXT -->
        <p class="text-[15px] text-gray-800 leading-relaxed max-w-[520px] mx-auto font-semibold">
            Proses seleksi sedang berlangsung. <br>
            <p> Harap menunggu jadwal pengumuman hasil seleksi yang akan diinformasikan <br></p>
            melalui dashboard resmi.
        </p>
