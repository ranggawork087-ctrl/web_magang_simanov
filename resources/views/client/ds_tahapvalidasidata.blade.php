...
<head>
  ...
  <title>SIMANOV - validasi data</title>
    ...
    <main class="flex-1 flex justify-center">
      <div class="bg-white p-12 rounded-2xl shadow-sm border border-[#E5E7EB] w-[780px] min-h-[360px] my-auto">
          ...
          <h1 class="text-xl font-bold leading-snug">
              Peserta dengan ID 
              <span id="peserta-id" class="text-[#0166FF] font-extrabold">{{ $pendaftaran->peserta_id }}</span>
              pada periode magang <br>
              {{ $pendaftaran->tanggal_mulai->format('d F Y') }} – {{ $pendaftaran->tanggal_berakhir->format('d F Y') }} saat ini <br>
              sedang dalam proses
          </h1>

          <div class="px-8 py-3 bg-[#22C55E] text-black rounded-[8px] font-semibold shadow-md w-fit">
              Validasi Data
          </div>
          </div>
      </div>
