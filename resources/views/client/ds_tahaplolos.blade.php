...
<body class="bg-white">
  ...
  <!-- Main container -->
 <div class="flex w-full px-4 md:px-10 py-14 gap-12 grow">
...
<aside class="bg-white rounded-xl border border-gray-200 w-64 select-none">
  ...
  <!-- ACTIVE -->
    ...
    <div class="bg-white p-12 rounded-2xl shadow-sm border border-[#E5E7EB]
                w-[780px] min-h-[360px] my-auto flex flex-col items-center text-center">

        <!-- ICON CENTANG -->
        <div class="w-20 h-20 mb-5 bg-[#EFF6FF] rounded-full flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-[#0166FF]" fill="none"
        ...
        <!-- TITLE -->
        <h1 class="text-2xl font-extrabold mb-3 text-gray-900 leading-snug">
            Selamat! Anda dinyatakan <span class="text-[#0166FF]">LOLOS SELEKSI</span>
            Program Magang BPSDMP Kominfo Surabaya
        </h1>

        <!-- SUBTEXT -->
        <p class="text-gray-600 text-sm leading-relaxed mb-8 max-w-md">
            Silahkan bergabung ke grup WhatsApp peserta magang melalui tautan berikut:
        </p>

        <!-- BUTTON -->
        <a href="https://chat.whatsapp.com/link-grup"
            class="w-full py-3 bg-[#0166FF] hover:bg-[#004ACC] transition text-white rounded-xl text-sm font-semibold shadow-md">
            Join WhatsApp Group
        </a>
