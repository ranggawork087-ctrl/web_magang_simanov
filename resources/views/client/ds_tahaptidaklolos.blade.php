...
<main class="flex-1 flex justify-center">
  ...
  <div class="bg-white p-12 rounded-2xl shadow-sm border border-[#E5E7EB] 
              w-[780px] min-h-[360px] my-auto flex items-center justify-center text-center">

      <h1 class="text-xl font-semibold text-gray-900 leading-relaxed">
          Mohon Maaf <br>
          Anda <span class="text-red-600">BELUM LOLOS</span> seleksi program magang kali ini <br>
          Terima kasih telah berpartisipasi <br>
          Tetap semangat untuk kesempatan berikutnya!
      </h1>
